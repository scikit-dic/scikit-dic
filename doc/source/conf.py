...
# -*- coding: utf-8 -*-
#
# skDIC documentation build configuration file, created by
# sphinx-quickstart on Tue Jul 12 15:05:21 2016.
#
...
sys.path.insert(0, os.path.abspath('../..'))
sys.path.insert(0, os.path.abspath('../../skDIC'))
...
latex_documents = [
    (master_doc, 'skDIC.tex', 'skDIC Documentation',
     'F. Boulogne', 'manual'),
]
...
man_pages = [
    (master_doc, 'skDIC', 'skDIC Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'skDIC', 'skDIC Documentation',
     author, 'skDIC', 'One line description of project.',
     'Miscellaneous'),
]
